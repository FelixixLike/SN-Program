...
class Hoja_2(QMainWindow):
    def __init__(self):
        super(Hoja_2, self).__init__()
        self.interface()

    def interface(self):
        self.setWindowIcon(QIcon("imagenes/buho.png"))
        self.setWindowTitle("Aproximaciones y errores de redondeo")
        ...
        self.button2 = QPushButton('Tipos de errores')
        self.button2.clicked.connect(self.change_to_page2)

        self.button3 = QPushButton('Errores de redondeo')
